...
<body>
    <header class="header">
        <div class="logo_navbar">
            <h2 class="logo_heading">Course Compass | Feedback</h2>
        </div>
    ...
    <div class="container" style="width:50%">
        <form action="{{ route('instructorfeedbackstore') }}" method="POST">
            @csrf

            <div class="form-group">
                <label for="feedback_for">Feedback For Student:</label>
